...
<div class="card card--search">
    ...
    <div class="card--actions">
      ...
      <div class="card--supplemental">
        <div class="card--action-item card--flag"><a aria-label="Flag" href="https://github.com/ryan-serpico/abcsofai.news/issues/new?assignees=palewire&labels=bug&template=flag-an-error.yaml&title=Error%20with%20{ encodeURIComponent(word) }&word={ encodeURIComponent(word) }"><Flag size=15 /></a></div>
